...
namespace CardReaderGui
{
	...
	public class APDUResponse
	{
		...
		private byte[]	m_baData = new byte[0];	
		private byte	m_bSw1;
		private byte	m_bSw2;
        ...
        /// <summary>
        /// The complete APDU, data + SW1, SW2
        /// </summary>
        public byte[] Packet
        {
            get
            {
                byte[] res = new byte[m_baData.Length + SW_LENGTH];
                Array.Copy(m_baData, res, m_baData.Length);
                res[res.Length - 2] = SW1;
